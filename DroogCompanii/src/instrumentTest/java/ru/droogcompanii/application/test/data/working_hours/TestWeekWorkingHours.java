...
public class TestWeekWorkingHours extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        workingHoursForEachDayOfWeek.onWednesday = new WorkingHoursOnBusinessDay(new TimeOfDay(9, 0), new TimeOfDay(20, 0));
        workingHoursForEachDayOfWeek.onThursday = new WorkingHoursOnBusinessDay(new TimeOfDay(9, 0), new TimeOfDay(19, 0));
        workingHoursForEachDayOfWeek.onFriday = new DayAndNightWorkingHours("All day");
        workingHoursForEachDayOfWeek.onSaturday = new WorkingHoursOnBusinessDay(new TimeOfDay(8, 0), new TimeOfDay(19, 30));
