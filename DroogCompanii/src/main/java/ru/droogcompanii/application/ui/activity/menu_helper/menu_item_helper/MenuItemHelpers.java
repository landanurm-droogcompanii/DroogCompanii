...
public class MenuItemHelpers {
    public static final MenuItemHelper SEARCH = new MenuItemHelper()
            .withId(MenuItemIds.SEARCH)
            .withOrder(MenuItemIds.SEARCH)
    ...
    public static final MenuItemHelper FILTER = new MenuItemHelper()
            .withId(MenuItemIds.FILTER)
            .withOrder(MenuItemIds.FILTER)
    ...
    public static final MenuItemHelper SIGNOUT = new MenuItemHelper()
            .withId(MenuItemIds.SIGNOUT)
            .withOrder(MenuItemIds.SIGNOUT)
    ...
    public static final MenuItemHelper PERSONAL_ACCOUNT = new MenuItemHelper()
            .withId(MenuItemIds.PERSONAL_ACCOUNT)
            .withOrder(MenuItemIds.PERSONAL_ACCOUNT)
    ...
    public static final MenuItemHelper SYNCHRONIZATION = new MenuItemHelper()
            .withId(MenuItemIds.SYNCHRONIZATION)
            .withOrder(MenuItemIds.SYNCHRONIZATION)
    ...
    public static final MenuItemHelper SETTINGS = new MenuItemHelper()
            .withId(MenuItemIds.SETTINGS)
            .withOrder(MenuItemIds.SETTINGS)
    ...
    public static final MenuItemHelper HELP = new MenuItemHelper()
            .withId(MenuItemIds.HELP)
            .withOrder(MenuItemIds.HELP)
