...
public class DummyAccountOwnerMaker {
    ...
    public static AccountOwner make() {
        ...
        personalDetails.setFirstName("Dummy First Name");
        personalDetails.setLastName("Dummy Last Name");
        personalDetails.setMiddleName("Dummy Middle Name");
